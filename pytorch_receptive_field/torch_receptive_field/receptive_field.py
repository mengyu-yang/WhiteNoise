...
def receptive_field(model, input_size, batch_size=-1, device="cuda"):
    ...
    def register_hook(module):
        ...
        if (
            ...
            and not isinstance(module, nn.Tanh)
        ):
    ...
    # print("------------------------------------------------------------------------------")
    # line_new = "{:>20}  {:>13} {:>10} {:>10} {:>15} ".format("Layer (type)", "map size", "start", "jump", "receptive_field")
    # print(line_new)
    # print("==============================================================================")
    # total_params = 0
    # total_output = 0
    ...
    #     line_new = "{:7} {:5} {:9}  {:>10} {:>10} {:>10} {:>15} ".format(
    #         "",
    #         layer,
    #         str(receptive_field[layer]["name"]),
...
def receptive_field_for_unit(receptive_field_dict, layer, unit_position):
    ...
    if layer in receptive_field_dict:
        ...
        print("Receptive field size for layer %s, unit_position %s,  is %s" % (layer, unit_position, rf_range))
        return rf_range
    else:
